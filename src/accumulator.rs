...
pub struct Accumulator {
    ...
    ///Accumulator value at time t
    ///Current accumulator state
    root: BigUint,

    ///The set of elements currently accumulated
    ///Product of the current set
    set: BigUint,
}
...
mod tests {
    ...
    fn test_static() {
        ...
        for _ in 0..100 {
            ...
            let xs = (0..5).map(|_| rng.gen_prime(int_size_bits)).collect::<Vec<_>>();
    ...
    fn test_batch_add_size(size: usize) {
        ...
        let xs = (0..size).map(|_| rng.gen_prime(int_size_bits)).collect::<Vec<_>>();
        ...
        assert!(acc.ver_batch_del(&w, &root, &set[..3]), "ver_batch_del failed");
    }
